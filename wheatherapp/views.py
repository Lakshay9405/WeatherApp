...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=22f3ed396978f53e4ddff4f5194429ba'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyATlsXxsLTX4q0STdOPExJR1SKr8i3reN0'

    SEARCH_ENGINE_ID = '21667a4230cec4232'
